...
<body>
	<form id="a" action="http://localhost:38080/pay_service_war_exploded/payment"  method="POST" target="_blank">
		<input type="hidden" name="trade_no" id="out_trade_no" value="硅谷商城订单<%=ran%>">
		<input type="hidden" name="total_fee" value="0.01">
		<input type="hidden" name="busi_return_url" value="http://localhost:18080/order_test_war_exploded/order_success.do">
		<input type="hidden" name="busi_notify_url" value="http://localhost:18080/order_test_war_exploded/order_notify.do">
